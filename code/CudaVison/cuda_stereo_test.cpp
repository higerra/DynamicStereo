...
//
//    CudaCamera cudacam;
//    cudacam.intrinsic[CudaCamera::FOCAL_LENGTH] = focal;
//    cudacam.intrinsic[CudaCamera::PRINCIPAL_POINT_X] = px;
//    cudacam.intrinsic[CudaCamera::PRINCIPAL_POINT_Y] = py;
//    cudacam.intrinsic[CudaCamera::RADIAL_DISTORTION_1] = r1;
//    cudacam.intrinsic[CudaCamera::RADIAL_DISTORTION_2] = r2;
//    cudacam.intrinsic[CudaCamera::ASPECT_RATIO] = 1.0;
//    cudacam.extrinsic[CudaCamera::ORIENTATION] = axis[0];
//    cudacam.extrinsic[CudaCamera::ORIENTATION+1] = axis[1];
//    cudacam.extrinsic[CudaCamera::ORIENTATION+2] = axis[2];
//    cudacam.extrinsic[CudaCamera::POSITION] = position[0];
//    cudacam.extrinsic[CudaCamera::POSITION + 1] = position[1];
//    cudacam.extrinsic[CudaCamera::POSITION + 2] = position[2];
//
...
TEST(CudaStereo, bilinear) {
    ...
    for (int k = 0; k < 5; ++k) {
        ...
        float pixCuda[3];
        bilinearInterpolation(ranMat.data, ranMat.cols, loc, pixCuda);
