...
/*******************************************************/
	...
	void MeanShift::classConsistencyCheck(int iN, bool usingLattice) {
		...
		//perform comparison...
		if (iN != kN) {
			ErrorHandler("MeanShift", "classConsitencyCheck",
...
/*******************************************************/
	...
	void MeanShift::ErrorHandler(const std::string &className, const std::string &methodName,
								 const std::string &errmsg) {

		//store trace into error message
		strcpy(ErrorMessage, className.data());
		strcat(ErrorMessage, "::");
		strcat(ErrorMessage, methodName.data());
		strcat(ErrorMessage, " Error: ");

		//store message into error message
		strcat(ErrorMessage, errmsg.data());
