...
//define prototype
	class msImageProcessor : public meanshift::MeanShift {
	...
	public:
		...
		void Filter(int, float, meanshift::SpeedUpLevel);
		...
		void Segment(int, float, int, meanshift::SpeedUpLevel);
		...
		meanshift::RegionList *GetBoundaries(void);
		...
		inline int GetRegionCount() const {return regionCount;};
	...
	private:
		...
		/////////Image Boundaries/////////
		meanshift::RegionList *regionList;            // stores the boundary locations for each region
		...
		meanshift::RAList *raList;                // an array of RAList objects containing an entry for each
		// region of the image

		//////////RAMatrix Free List///////////
		meanshift::RAList *freeRAList;            // a pointer to the head of a region adjacency list object
		// free list

		meanshift::RAList *raPool;                // a pool of RAList objects used in the construction of the
		// RAM
