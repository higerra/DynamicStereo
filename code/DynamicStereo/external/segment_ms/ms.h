...
//MeanShift Prototype
	...
	protected:
		...
		void classConsistencyCheck(int,
								   bool);                // checks to see that a kernel is created and input defined, as
		...
		void ErrorHandler(const std::string &, const std::string &,
						  const std::string &);                // flags an error and halts the system
	...
	private:
		...
		void InitializeInput(
				float *);                        // Allocates memory for and initializes the input data structure
