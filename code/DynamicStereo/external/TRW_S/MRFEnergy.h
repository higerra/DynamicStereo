...
public:
	...
	REAL ComputeSolutionAndEnergy(const int start_index);
	int changeOrdering(const std::vector<int> &ordering);
...
#include "MRFEnergy.def"
#include "minimize.def"
#include "treeProbabilities.def"
#include "ordering.def"
