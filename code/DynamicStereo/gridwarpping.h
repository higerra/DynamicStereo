...
namespace dynamic_stereo {
    ...
    public:
        ...
        GridWarpping(const FileIO& file_io_, const std::vector<cv::Mat>& images_, const StereoModel<EnergyType>& model_,
                     const theia::Reconstruction& reconstruction_, const int downsample_, const int offset_, const int gw = 32, const int gh = 18);
