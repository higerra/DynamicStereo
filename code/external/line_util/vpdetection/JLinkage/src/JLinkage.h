...
// Simply uncomment this line_util if you don't want to use threads
...
public:
	...
	std::list<sPtLnkPointer> FindKNearest(sPtLnkPointer __V, float const __Max_R, int k, int nMaxSize);
